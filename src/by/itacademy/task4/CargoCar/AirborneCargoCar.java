...
public class AirborneCargoCar extends CargoCar{

    public AirborneCargoCar(String stateNumber, String brand, String model, double fuelConsumption, double price, double velocity,
